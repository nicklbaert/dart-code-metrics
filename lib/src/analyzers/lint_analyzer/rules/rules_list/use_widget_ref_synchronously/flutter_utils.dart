...
FlutterUtils _flutterInstance = FlutterUtils('flutter', 'package:flutter');

FlutterUtils get _flutter => _flutterInstance;
...
class FlutterUtils {
  ...
  FlutterUtils(this.packageName, String uriPrefix)
